"""
MAC Address Locator for VOSS/Fabric Engine
=========================================
...
IP address of the next switch in the path, and iteratively continues this process until it finds the switch where the MAC address is local
or reaches a defined jump limit.

Author: Mathis Morvant
Dependencies : XIQSE SDK by Thibault Chevalleraud
"""
